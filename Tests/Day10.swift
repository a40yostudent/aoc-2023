...
final class Day10Tests: XCTestCase {
	...
	func testPart2() throws {
		let challenge2 = Day10(data: testData.2)
		XCTAssertEqual(String(describing: challenge2.part2()), "4")
		
		let challenge3 = Day10(data: testData.3)
		XCTAssertEqual(String(describing: challenge3.part2()), "8")
		
		let challenge4 = Day10(data: testData.4)
		XCTAssertEqual(String(describing: challenge4.part2()), "10")
	}
}
